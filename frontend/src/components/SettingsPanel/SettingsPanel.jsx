  ...
  return (
    <div className="stg-panel">
      <div className="stg-panel__header">
        <span>⚙ Settings</span>
        {onClose && (
          <button type="button" className="stg-panel__close" onClick={onClose} aria-label="Close settings">
            ✕
          </button>
        )}
      </div>
      ...
      <div className="stg-list">
        ...
        {/* Notifications — toggle + lead time, one line */}
        <div className="stg-item">
          <span className="stg-item__icon">🔔</span>
        ...
        {/* Data & Sync — one line, two buttons */}
        <div className="stg-item">
          <span className="stg-item__icon">🔄</span>
        ...
        {/* Account actions — one line, two buttons */}
        <div className="stg-item">
